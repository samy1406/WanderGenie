...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a travel agent. Based on the user's origin, destination, and travel preference, provide three distinct travel options (e.g., one flight, one train, one bus if applicable). 
